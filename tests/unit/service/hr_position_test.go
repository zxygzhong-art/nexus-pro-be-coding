...
func TestHRPositionCreateAndUpdateRollbackWhenAuditFails(t *testing.T) {
	store, baseService, ctx := newEmployeeFeatureFixture(t, hrPositionPermissions())
...
func TestEmployeePositionStringCompatibilityDoubleWritesPositionEntity(t *testing.T) {
	store, svc, ctx := newEmployeeFeatureFixture(t, hrPositionPermissions(), service.Options{Now: func() time.Time {
...
func hrPositionPermissions() []domain.Permission {
