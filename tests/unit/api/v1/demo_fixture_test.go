...
func populateDemoFixture(store repository.Store) {
	...
	adminSet := PermissionSet{
		...
		Permissions: []Permission{
			...
			{Resource: "iam.user_group", Action: "update", Scope: "all", MenuKey: "iam.user_groups"},
			...
			{Resource: "agent.tool", Action: "read", Scope: "all", MenuKey: "agents.runs"},
			{Resource: "agent.tool", Action: "create", Scope: "all", MenuKey: "agents.runs"},
			{Resource: "agent.tool", Action: "delete", Scope: "all", MenuKey: "agents.runs"},
			...
			{Resource: "agent.tool", Action: "call", Target: "create_form_draft", Scope: "all", MenuKey: "agents.runs"},
			{Resource: "agent.tool", Action: "call", Target: "update_form_draft", Scope: "all", MenuKey: "agents.runs"},
			{Resource: "agent.tool", Action: "call", Target: "preview_form_submission", Scope: "all", MenuKey: "agents.runs"},
			{Resource: "agent.tool", Action: "call", Target: "prepare_bulk_review", Scope: "all", MenuKey: "agents.runs"},
		...
		Schema: map[string]any{
			...
			"workspace_design": map[string]any{
				...
				"fields": []map[string]any{
					{"id": "leave_type", "type": "select", "label": "假勤名稱", "placeholder": "請選擇", "required": true},
					{"id": "start_at", "type": "datetime", "label": "開始時間", "placeholder": "選擇日期時間", "required": true},
					{"id": "end_at", "type": "datetime", "label": "結束時間", "placeholder": "選擇日期時間", "required": true},
					{"id": "hours", "type": "number", "label": "請假時數", "placeholder": "0", "required": true},
					{"id": "proxy", "type": "select", "label": "代理人", "placeholder": "請選擇代理人", "required": true},
