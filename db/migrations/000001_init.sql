...
CREATE UNIQUE INDEX roles_company_code_idx ON roles (company_id, code);
...
CREATE UNIQUE INDEX workspaces_company_slug_idx ON workspaces (company_id, slug);
...
CREATE UNIQUE INDEX workspace_users_workspace_user_idx ON workspace_users (workspace_id, user_id);
CREATE INDEX workspace_users_company_id_idx ON workspace_users (company_id);
...
CREATE TABLE agents (
    ...
    name text NOT NULL,
    agent_image text NOT NULL DEFAULT 'purple',
    agent_type text NOT NULL DEFAULT 'ai_assistant',
...
CREATE TABLE knowledges (
    ...
    milvus_collection_id text NOT NULL DEFAULT '',
...
CREATE INDEX knowledges_company_id_idx ON knowledges (company_id);
...
CREATE UNIQUE INDEX agent_knowledges_agent_knowledge_idx ON agent_knowledges (agent_id, knowledge_id);
CREATE INDEX agent_knowledges_company_id_idx ON agent_knowledges (company_id);

CREATE TABLE knowledge_user_permissions (
    id uuid PRIMARY KEY,
    company_id integer NOT NULL REFERENCES companies(id) ON DELETE CASCADE,
    knowledge_id uuid NOT NULL REFERENCES knowledges(id) ON DELETE CASCADE,
    user_id uuid NOT NULL REFERENCES users(id) ON DELETE CASCADE,
...
CREATE UNIQUE INDEX knowledge_user_permissions_unique_idx ON knowledge_user_permissions (knowledge_id, user_id, permission);
CREATE INDEX knowledge_user_permissions_company_id_idx ON knowledge_user_permissions (company_id);
...
CREATE INDEX company_storage_configs_company_id_idx ON company_storage_configs (company_id);

CREATE TABLE files (
    id uuid PRIMARY KEY,
    company_id integer NOT NULL REFERENCES companies(id) ON DELETE CASCADE,
    knowledge_id uuid REFERENCES knowledges(id) ON DELETE SET NULL,
    storage_config_id uuid REFERENCES company_storage_configs(id) ON DELETE SET NULL,
...
CREATE INDEX files_knowledge_id_idx ON files (knowledge_id);
...
CREATE INDEX file_process_tasks_file_id_idx ON file_process_tasks (file_id);
CREATE INDEX file_process_tasks_company_status_idx ON file_process_tasks (company_id, status);

CREATE TABLE agent_platform_files (
    id uuid PRIMARY KEY,
    company_id integer NOT NULL REFERENCES companies(id) ON DELETE CASCADE,
...
CREATE INDEX agent_platform_files_company_id_idx ON agent_platform_files (company_id);
CREATE INDEX agent_platform_files_file_id_idx ON agent_platform_files (file_id);

CREATE TABLE pricing_plans (
    id uuid PRIMARY KEY,
    code text NOT NULL UNIQUE,
    name text NOT NULL,
    message_limit integer NOT NULL DEFAULT 0 CHECK (message_limit >= 0),
...
CREATE INDEX licenses_company_id_idx ON licenses (company_id);
...
CREATE POLICY company_isolation_roles ON roles USING (company_id::text = current_setting('app.company_id', true)) WITH CHECK (company_id::text = current_setting('app.company_id', true));
CREATE POLICY company_isolation_workspaces ON workspaces USING (company_id::text = current_setting('app.company_id', true)) WITH CHECK (company_id::text = current_setting('app.company_id', true));
CREATE POLICY company_isolation_workspace_users ON workspace_users USING (company_id::text = current_setting('app.company_id', true)) WITH CHECK (company_id::text = current_setting('app.company_id', true));
CREATE POLICY company_isolation_agents ON agents USING (company_id::text = current_setting('app.company_id', true)) WITH CHECK (company_id::text = current_setting('app.company_id', true));
CREATE POLICY company_isolation_knowledges ON knowledges USING (company_id::text = current_setting('app.company_id', true)) WITH CHECK (company_id::text = current_setting('app.company_id', true));
CREATE POLICY company_isolation_agent_knowledges ON agent_knowledges USING (company_id::text = current_setting('app.company_id', true)) WITH CHECK (company_id::text = current_setting('app.company_id', true));
CREATE POLICY company_isolation_knowledge_user_permissions ON knowledge_user_permissions USING (company_id::text = current_setting('app.company_id', true)) WITH CHECK (company_id::text = current_setting('app.company_id', true));
CREATE POLICY company_isolation_company_storage_configs ON company_storage_configs USING (company_id::text = current_setting('app.company_id', true)) WITH CHECK (company_id::text = current_setting('app.company_id', true));
CREATE POLICY company_isolation_files ON files USING (company_id::text = current_setting('app.company_id', true)) WITH CHECK (company_id::text = current_setting('app.company_id', true));
CREATE POLICY company_isolation_file_process_tasks ON file_process_tasks USING (company_id::text = current_setting('app.company_id', true)) WITH CHECK (company_id::text = current_setting('app.company_id', true));
CREATE POLICY company_isolation_agent_platform_files ON agent_platform_files USING (company_id::text = current_setting('app.company_id', true)) WITH CHECK (company_id::text = current_setting('app.company_id', true));
...
DROP TABLE IF EXISTS agent_platform_files;
DROP TABLE IF EXISTS file_process_tasks;
DROP TABLE IF EXISTS files;
DROP TABLE IF EXISTS company_storage_configs;
DROP TABLE IF EXISTS knowledge_user_permissions;
