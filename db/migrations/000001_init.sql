...
ALTER TABLE agent_runs DROP CONSTRAINT IF EXISTS agent_runs_session_fk;
ALTER TABLE workflow_runs DROP CONSTRAINT IF EXISTS workflow_runs_current_stage_fk;
...
DROP TABLE IF EXISTS attendance_policy_versions;
...
DROP FUNCTION IF EXISTS sync_group_membership_projections();
DROP FUNCTION IF EXISTS refresh_group_membership_projection(text, text, text);
