...
var DefaultRoutePolicies = []RoutePolicy{
	...
	{Name: "attendance.ehrms_leave_type.read", Method: "GET", Path: "/v1/attendance/ehrms/leave-types", ApplicationCode: "attendance", ResourceType: "leave", Action: "read"},
	{Name: "attendance.ehrms_leave_type.sync", Method: "POST", Path: "/v1/attendance/ehrms/leave-types/sync", ApplicationCode: "attendance", ResourceType: "leave", Action: "update", RiskLevel: RiskHigh},
