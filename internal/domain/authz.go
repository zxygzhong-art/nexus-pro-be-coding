...
var DefaultRoutePolicies = []RoutePolicy{
	...
	{Name: "iam.user_group.delete", Method: "DELETE", Path: "/v1/iam/user-groups/:id", ApplicationCode: "iam", ResourceType: "user_group", Action: "delete", RiskLevel: RiskHigh},
	...
	{Name: "iam.permission_set.delete", Method: "DELETE", Path: "/v1/iam/permission-sets/:id", ApplicationCode: "iam", ResourceType: "permission_set", Action: "delete", RiskLevel: RiskHigh},
	...
	{Name: "iam.assumable_role.update", Method: "PATCH", Path: "/v1/iam/assumable-roles/:id", ApplicationCode: "iam", ResourceType: "assumable_role", Action: "update", RiskLevel: RiskHigh},
	{Name: "iam.assumable_role.delete", Method: "DELETE", Path: "/v1/iam/assumable-roles/:id", ApplicationCode: "iam", ResourceType: "assumable_role", Action: "delete", RiskLevel: RiskHigh},
	...
	{Name: "attendance.leave.grant_balance", Method: "POST", Path: "/v1/attendance/leave-balances/grant", ApplicationCode: "attendance", ResourceType: "leave", Action: "update", RiskLevel: RiskHigh},
	...
	{Name: "attendance.ehrms.sync", Method: "POST", Path: "/v1/attendance/ehrms/sync", ApplicationCode: "attendance", ResourceType: "clock", Action: "import", RiskLevel: RiskHigh},
	...
	{Name: "workspace.turnover.export", Method: "GET", Path: "/v1/workspace/turnover/export", ApplicationCode: "hr", ResourceType: "employee", Action: "export", RiskLevel: RiskHigh},
	...
	{Name: "workspace.attendance.export", Method: "GET", Path: "/v1/workspace/attendance/export", ApplicationCode: "attendance", ResourceType: "clock", Action: "export", RiskLevel: RiskHigh},
	...
	{Name: "workspace.agent_definition.templates", Method: "GET", Path: "/v1/workspace/agents/templates", ApplicationCode: "agent", ResourceType: "definition", Action: "read"},
	...
	{Name: "workspace.agent_definition.audits", Method: "GET", Path: "/v1/workspace/agents/audits", ApplicationCode: "agent", ResourceType: "definition", Action: "read"},
	{Name: "workspace.agent_definition.bundle_export", Method: "GET", Path: "/v1/workspace/agents/bundle", ApplicationCode: "agent", ResourceType: "definition", Action: "read"},
	{Name: "workspace.agent_definition.bundle_import", Method: "POST", Path: "/v1/workspace/agents/bundle", ApplicationCode: "agent", ResourceType: "definition", Action: "create", RiskLevel: RiskHigh},
	...
	{Name: "agent.run.chat", Method: "POST", Path: "/v1/agents/chat", ApplicationCode: "agent", ResourceType: "run", Action: "create", RiskLevel: RiskHigh},
	{Name: "agent.session.read", Method: "GET", Path: "/v1/agents/sessions", ApplicationCode: "agent", ResourceType: "run", Action: "read"},
	{Name: "agent.session.create", Method: "POST", Path: "/v1/agents/sessions", ApplicationCode: "agent", ResourceType: "run", Action: "create", RiskLevel: RiskHigh},
	{Name: "agent.session.detail", Method: "GET", Path: "/v1/agents/sessions/:id", ApplicationCode: "agent", ResourceType: "run", Action: "read"},
	{Name: "agent.session.update", Method: "PATCH", Path: "/v1/agents/sessions/:id", ApplicationCode: "agent", ResourceType: "run", Action: "update", RiskLevel: RiskHigh},
	{Name: "agent.session.clear_context", Method: "POST", Path: "/v1/agents/sessions/:id/clear-context", ApplicationCode: "agent", ResourceType: "run", Action: "create", RiskLevel: RiskHigh},
	{Name: "agent.session.delete", Method: "DELETE", Path: "/v1/agents/sessions/:id", ApplicationCode: "agent", ResourceType: "run", Action: "delete", RiskLevel: RiskHigh},
	...
	{Name: "agent.memory.create", Method: "POST", Path: "/v1/agents/memories", ApplicationCode: "agent", ResourceType: "run", Action: "create", RiskLevel: RiskHigh},
	{Name: "agent.memory.update", Method: "PATCH", Path: "/v1/agents/memories/:id", ApplicationCode: "agent", ResourceType: "run", Action: "update", RiskLevel: RiskHigh},
	{Name: "agent.memory.delete", Method: "DELETE", Path: "/v1/agents/memories/:id", ApplicationCode: "agent", ResourceType: "run", Action: "delete", RiskLevel: RiskHigh},
