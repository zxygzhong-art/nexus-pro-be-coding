...
var DefaultRoutePolicies = []RoutePolicy{
	...
	{Name: "platform.workspace_audit_logs.read", Method: "GET", Path: "/v1/platform/workspace/audit-logs", ApplicationCode: "audit", ResourceType: "audit_log", Action: "read", RiskLevel: RiskHigh},
