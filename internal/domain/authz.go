...
var DefaultRoutePolicies = []RoutePolicy{
	...
	{Name: "workspace.organization_visibility.update", Method: "PATCH", Path: "/v1/workspace/organization/employees/:id/visibility", ApplicationCode: "hr", ResourceType: "employee", Action: "update"},
	...
	{Name: "workflow.review_queue.bulk_action", Method: "POST", Path: "/v1/workflows/reviews/bulk-action", ApplicationCode: "workflow", ResourceType: "form_instance", Action: "read"},
	...
	{Name: "workflow.form_instance.approve", Method: "POST", Path: "/v1/workflows/forms/:id/approve", ApplicationCode: "workflow", ResourceType: "form_instance", Action: "read"},
	{Name: "workflow.form_instance.reject", Method: "POST", Path: "/v1/workflows/forms/:id/reject", ApplicationCode: "workflow", ResourceType: "form_instance", Action: "read"},
	{Name: "workflow.form_instance.return", Method: "POST", Path: "/v1/workflows/forms/:id/return", ApplicationCode: "workflow", ResourceType: "form_instance", Action: "read"},
