...
func tenantProvisionAdminPermissions() []domain.Permission {
	permissions := []domain.Permission{
		...
		{Resource: "attendance.shift_assignment", Action: domain.ActionRead, Scope: domain.ScopeAll, MenuKey: "attendance.shift_assignments"},
		{Resource: "attendance.shift_assignment", Action: domain.ActionCreate, Scope: domain.ScopeAll, MenuKey: "attendance.shift_assignments"},
		{Resource: "attendance.shift_assignment", Action: domain.ActionUpdate, Scope: domain.ScopeAll, MenuKey: "attendance.shift_assignments"},
