...
type IAMFacade interface {
	...
	ListUserGroupPage(RequestContext, string, PageRequest) (PageResponse[UserGroup], error)
	...
	ListIamAccountOptions(RequestContext, OptionQuery) (OptionPage, error)
	ListPermissionSetOptions(RequestContext, OptionQuery) (OptionPage, error)
	ListUserGroupOptions(RequestContext, OptionQuery) (OptionPage, error)
	ListAssumableRoleOptions(RequestContext, OptionQuery) (OptionPage, error)
...
type HRFacade interface {
	...
	ListOrgUnitPage(RequestContext, OrgUnitQuery) (PageResponse[OrgUnit], error)
...
type AttendanceFacade interface {
	...
	ListLeaveTypes(RequestContext) (LeaveTypeCatalog, error)
	SetLeaveTypeEnabled(RequestContext, string, SetLeaveTypeEnabledInput) (LeaveType, error)
...
type WorkspaceFacade interface {
	...
	WorkspaceOrgUnitsDirectory(RequestContext, bool) (WorkspaceOrgUnitDirectoryResponse, error)
	...
	WorkspaceClockAbnormals(RequestContext, WorkspaceClockAbnormalQuery) (WorkspaceClockAbnormalResponse, error)
...
type WorkflowFacade interface {
	...
	UploadFormInstanceFile(RequestContext, string, domain.UploadFormInstanceFileInput) (domain.FormInstanceFile, error)
	ListFormInstanceFiles(RequestContext, string) ([]domain.FormInstanceFile, error)
	DownloadFormInstanceFile(RequestContext, string, string) (domain.FormInstanceFileDownload, error)
	DeleteFormInstanceFile(RequestContext, string, string) (domain.FormInstanceFile, error)
}
...
type AgentFacade interface {
	...
	ListSessions(RequestContext, domain.ListAgentSessionsQuery) (domain.AgentSessionListPage, error)
	...
	ListSessionMessages(RequestContext, string, domain.ListAgentSessionMessagesQuery) (domain.AgentSessionMessageListPage, error)
	...
	ListKnowledgeBases(RequestContext, PageRequest) (PageResponse[domain.KnowledgeBase], error)
	...
	ListKnowledgeDocuments(RequestContext, string, PageRequest) (PageResponse[domain.KnowledgeDocument], error)
	GetKnowledgeDocument(RequestContext, string, string) (domain.KnowledgeDocument, error)
	...
	TestExternalTool(RequestContext, string) (domain.AgentExternalTool, error)
	DiscoverExternalTool(RequestContext, string) (domain.AgentExternalTool, error)
