...
type Querier interface {
	...
	GetExternalLeaveRecordByRef(ctx context.Context, arg GetExternalLeaveRecordByRefParams) (LeaveExternalRecord, error)
	...
	ListExternalLeaveRecords(ctx context.Context, tenantID string) ([]LeaveExternalRecord, error)
	...
	UpsertExternalLeaveRecord(ctx context.Context, arg UpsertExternalLeaveRecordParams) (LeaveExternalRecord, error)
