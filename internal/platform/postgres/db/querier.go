...
type Querier interface {
	...
	GetLeaveCaseBySource(ctx context.Context, arg GetLeaveCaseBySourceParams) (GetLeaveCaseBySourceRow, error)
	...
	UpsertLeaveCaseSource(ctx context.Context, arg UpsertLeaveCaseSourceParams) (LeaveCaseSource, error)
