...
type Querier interface {
	...
	GetAttendanceClockRecord(ctx context.Context, arg GetAttendanceClockRecordParams) (AttendanceClockRecord, error)
	...
	GetAttendanceShiftAssignment(ctx context.Context, arg GetAttendanceShiftAssignmentParams) (AttendanceShiftAssignment, error)
